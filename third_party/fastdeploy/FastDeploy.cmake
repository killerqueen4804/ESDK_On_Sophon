...
if(ENABLE_VISION)
  ...
  # Win/Linux/Mac
    ...
    set(OpenCV_LIBS_DIR /workspace/ESDK_On_Sophon/third_party/opencv4.2/lib/*)

    list(APPEND FASTDEPLOY_INCS /workspace/ESDK_On_Sophon/third_party/opencv4.2/include)
    list(APPEND FASTDEPLOY_LIBS ${OpenCV_LIBS})
  endif()
